...
def register(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
           ...
           return redirect('email-verifiacation-sent')

    context = {'form':form}


    return render(request,
                  'account/registration/register.html',context=context)
...
def email_verification(request,uidb64,token):
    ...
    if user and user_tokenizer_generate.check_token(user,token):
       ...
       return redirect('email-verifiacation-success')

    #Failed
    else:
        return redirect('email-verifiacation-failed')
...
def manage_shipping(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            #Assign the user ForeignKey on the object
